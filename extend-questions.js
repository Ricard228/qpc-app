...
console.log(`  Manche 1 : +${r1.added} packs (${r1.skipped} doublons ignorés)`);
console.log(`  Manche 2 : +${r2.added} packs (${r2.skipped} doublons ignorés)`);
console.log(`  Manche 3 : +${r3.added} packs (${r3.skipped} doublons ignorés)`);
